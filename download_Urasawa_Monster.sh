...
display_usage(){
	...
	echo -e "\
Description:\n\
  Downloads specified chapters of Naoki Urasawa's manga \"Monster\" from \"monster-manga.com\" \n\n\
Usage:\n\
...
Example:\n\
  ./download_Urasawa_Monster.sh 160 162 dump-chapters-into-separate-folders ~/Desktop/Urasawa_Monster2"
...
do
	...
	if [[ "$mode" -eq 0 ]]; then
		download_dir="$output_dir/Urasawa_Monster"
	else
		download_dir="$output_dir/Urasawa_Monster/$padded_chapter_number"
	fi
